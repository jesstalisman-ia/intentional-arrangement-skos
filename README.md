...
- **Crosswalk (thesaurus building).** Align two taxonomies from your workspace with the five SKOS mapping relations. Auto-match proposes links from identical/near labels; confirm or draw your own in a visual side-by-side view. Export the crosswalk alone or the federated thesaurus (both schemes + mappings) as one RDF file; mappings also ride along in normal exports.
